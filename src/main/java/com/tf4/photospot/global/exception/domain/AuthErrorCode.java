...
public enum AuthErrorCode implements ApiErrorCode {
	...
	INVALID_APPLE_PUBLIC_KEY(HttpStatus.BAD_REQUEST, "Apple public key가 유효하지 않습니다."),
	FAIL_GENERATE_APPLE_PUBLIC_KEY(HttpStatus.BAD_REQUEST, "Apple public key 생성을 실패했습니다."),
	FAIL_PARSE_HEADER_FROM_APPLE_TOKEN(HttpStatus.UNAUTHORIZED, "Apple Identify Token에서 헤더를 가져오는 데 실패했습니다."),
	...
	EMPTY_APPLE_AUTHORIZATION_CODE(HttpStatus.BAD_REQUEST, "사용자 authorization code가 비어있습니다."),
